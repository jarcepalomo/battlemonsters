      ...
      <form onSubmit={handleSubmit} className="relative group">
        ...
        <div className="relative">
          ...
          <textarea
            ...
            className="w-full pl-12 pr-12 py-4 bg-gray-800/50 border border-purple-500/30 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200 backdrop-blur-sm resize-none leading-6"
            style={{ 
          ...
          <button
            ...
            className="absolute right-2 top-4 p-2 rounded-md bg-gradient-to-r from-purple-600 to-pink-600 text-white disabled:opacity-50 disabled:cursor-not-allowed hover:from-purple-500 hover:to-pink-500 transition-all duration-200 shadow-lg hover:shadow-purple-500/25 z-10"
